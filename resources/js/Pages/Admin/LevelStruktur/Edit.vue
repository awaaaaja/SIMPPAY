...
function submit() {
    form.put(route(`${prefix.value}.level-struktur.update`, props.item.id));
}
</script>

<template>
    <Head title="Edit Level Struktur" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Level Struktur</h2>
