...
function submit() {
    form.post(route(`${prefix.value}.golongan-ruang.store`));
}
</script>

<template>
    <Head title="Tambah Golongan Ruang" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Tambah Golongan Ruang</h2>
