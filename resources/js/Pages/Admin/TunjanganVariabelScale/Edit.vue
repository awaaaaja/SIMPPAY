...
const form = useForm({
    ...
    nominal_maksimum: props.item.nominal_maksimum,
});

function submit() {
    form.put(route(`${prefix.value}.tunjangan-variabel-scale.update`, props.item.id));
}
</script>

<template>
    <Head title="Edit Tunjangan Variabel Scale" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Tunjangan Variabel Scale</h2>
