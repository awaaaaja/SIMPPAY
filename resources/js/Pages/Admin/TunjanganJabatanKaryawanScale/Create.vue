...
function submit() {
    form.post(route(`${prefix.value}.tunjangan-jabatan-karyawan-scale.store`));
}
</script>

<template>
    <Head title="Tambah Tunjangan Jabatan Karyawan Scale" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Tambah Tunjangan Jabatan Karyawan Scale</h2>
