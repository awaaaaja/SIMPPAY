...
const fields = {
    ...
    kepegawaian: [
        ...
        { label: 'Golongan Ruang', key: 'golonganRuang.kode' },
        { label: 'Jabatan Struktural', key: 'jabatanStrukturalPoin.nama_jabatan' },
        { label: 'TMT', key: 'tmt', format: formatDate },
        { label: 'Status Dosen', key: 'status_dosen' },
        { label: 'Strata Pendidikan', key: 'strata_pendidikan', format: (v) => ({ profesor: 'Profesor', s3: 'S.3 / Dr', s2: 'S.2 / Magister', lainnya: 'Lainnya' }[v] ?? '-') },
        { label: 'Program Mengajar', key: 'program_mengajar', format: (v) => ({ s1: 'Program S1', s2: 'Program S2' }[v] ?? '-') },
        { label: 'NIDN', key: 'nidn' },
