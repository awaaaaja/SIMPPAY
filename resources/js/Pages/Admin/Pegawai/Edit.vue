...
const form = useForm({
    ...
    struktural_id: p.struktural_id ?? '',
    fungsional_id: p.fungsional_id ?? '',
    email: p.email ?? '',
    no_hp: p.no_hp ?? '',
    alamat: p.alamat ?? '',
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <TextInput id="ikatan_kerja" v-model="form.ikatan_kerja" type="text" class="mt-1 block w-full" />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <InputLabel value="Ganti Foto Pegawai" />
                                <FileUpload
                                    v-model="form.photo"
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4">
                            <Link :href="route(`${prefix}.pegawai.show`, pegawai.id)" class="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50">Batal</Link>
