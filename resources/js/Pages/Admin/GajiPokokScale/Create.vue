...
function submit() {
    form.post(route(`${prefix.value}.gaji-pokok-scale.store`));
}
</script>

<template>
    <Head title="Tambah Gaji Pokok Scale" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Tambah Gaji Pokok Scale</h2>
                ...
                <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            ...
                            <Input id="mkg" v-model="form.mkg" type="number" min="0" max="30" step="2" class="mt-1" required />
