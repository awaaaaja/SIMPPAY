...
class PegawaiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'golongan_ruang_id' => ['nullable', 'exists:golongan_ruang,id'],
            'jabatan_struktural_poin_id' => ['nullable', 'exists:jabatan_struktural_poin,id'],
            ...
            'strata_pendidikan' => ['nullable', 'in:profesor,s3,s2,lainnya'],
            'program_mengajar' => ['nullable', 'in:s1,s2'],
